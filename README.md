...
<img src="https://upload.wikimedia.org/wikipedia/commons/7/79/Termux-logo.png" width="80"/>
...
```bash
git clone https://github.com/r7yukii23-cmyk/milimnava-base.git
cd milimnava-base
npm install
node index.js
```
...
```bash
npm install -g pm2
pm2 start index.js --name yue-bot
pm2 save
pm2 startup
```
...
Terima kasih telah menggunakan YUE BASE.
